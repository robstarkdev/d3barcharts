...
<div id="getdata" class="btn_simple"><span style="margin: auto;">Get Data</span></div>
...
//            d3.json('json_return.php').post(country,function (json) {
//
//                 alert("caught this: " + json;)
//
//            });

        // ... end btn getdata click
        });
